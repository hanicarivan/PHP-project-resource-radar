    ...
    <main>
        <section>
            ...
            <div class="article-section">
                <?php
                    $query = "SELECT id, slika, naslov, datum FROM vijesti WHERE arhiva = 0 AND kategorija='crude' LIMIT 3";
        ...
        <section>
            ...
            <div class="article-section">
                <?php
                    $query = "SELECT id, slika, naslov, datum FROM vijesti WHERE arhiva = 0 AND kategorija='gas' LIMIT 3";
                    $result = mysqli_query($dbc, $query);
                    $i = 0;
                    while($row = mysqli_fetch_array($result)){
                        echo "<article>";
